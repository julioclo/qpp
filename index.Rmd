...
**RQ**: In second language acquisition, does the re-ranking of the constraints that regulate the features involved in a structure result in cross-linguistic influence?

**H**: **Yes**, in second language acquisition, the re-ranking of the constraints that regulate the features involved in a specific structure results in cross-linguistic influence. 
...
- Further research on the acquisition of other structures requiring the re-ranking of the constraints that regulate interpretable features is needed to test this hypothesis (e.g., Spanish speakers learning Romanian as an L2).
---
class: center, middle
#¡Gracias!
#Mulțumesc!
